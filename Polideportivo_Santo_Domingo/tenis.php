...
<head>
    ...
    <link href="css/style_tenis.css" rel="stylesheet">
    ...
    <div class="wrapper">
        ...
        <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main_text">
                                <?php
                                echo '<h1>Academia <br><strong class="bold_text">Tenis</strong><br><strong class="bold_text_black">Santo Domingo</strong></h1>';
                                ?>
                            </div>
                        </div>
                    </div>
            ...
            <article class="tenis">
                ...
                <div id="tenisCarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">

                        <div class="carousel-item active">
                            <img class="d-block w-100" src="images/tenis1.jpg" alt="Primera foto">
                        </div>

                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/tenis2.jpg" alt="Segunda foto">
                        </div>

                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/tenis3.jpg" alt="Tercera foto">
                        </div>

                    </div>

                    <a class="carousel-control-prev" href="#tenisCarousel" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Anterior</span>
                    </a>

                    <a class="carousel-control-next" href="#tenisCarousel" role="button" data-slide="next">
                ...
                <div class="resumen-academia">
                    <p>
                        La academia de tenis Santo Domingo se dedica a formar jóvenes talentos en el deporte de la
                        raqueta...
                    </p>
                    <p>
                        Nuestras instalaciones están equipadas con todo lo necesario para la práctica del tenis...
                    </p>
                </div>
